...
exports.getProduct = async function (req, res) {
  await Utils.checkIfResultIsNullValidation(req, res, () => ProductService.retrieveProduct(req.params.sku));
};
...
exports.patchProduct = async function (req, res) {
  await Utils.checkIfResultIsNullValidation(req, res, () => ProductService.updateProduct(req.params, req.body));
};
